...
| `herdr-faq` | 0.2.0 | [zip](https://github.com/tenequm/skills/releases/download/skills-latest/herdr-faq.zip) | [page](https://clawhub.ai/tenequm/skills/herdr-faq) | Launch and drive coding agents (codex, claude, agy) through the Herdr CLI reliably. Use before starting or prompting a subagent via herdr agent/pane commands, and when any herdr command fails or an agent seems stuck, silently lost a prompt, or reports a wrong state. |
