...
|-------|---------|--------|---------|-------------|
| `acpx-faq` | 0.2.1 | [zip](https://github.com/tenequm/skills/releases/download/skills-latest/acpx-faq.zip) | [page](https://clawhub.ai/tenequm/skills/acpx-faq) | Run coding agents (codex, claude, Antigravity/agy) headlessly through the acpx ACP CLI. Use before launching or prompting an acpx subagent, and when an acpx command fails, a session is not found, or a prompt seems lost. |
