...
2. **Where should we look?** Available glim primitives: web (search + crawl), GitHub, Reddit, Twitter / X, Amazon, YouTube subtitles. Pick whichever fit the topic.
...
- Small / fillable solo: run 1-2 targeted glim searches yourself
