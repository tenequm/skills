...
Used by deleted upstream X adapter (Node.js Bird search) and deleted upstream YouTube adapter (yt-dlp search
    ...
    *,
    ...
    Args:
        ...
        on_pid: Optional callable invoked with the child PID right after
            spawn. Used by deleted upstream X adapter to register child PIDs for cleanup
