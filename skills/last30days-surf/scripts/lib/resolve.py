...
Uses surf web search (single backend) to discover relevant communities and context
...
from . import surf_adapters as grounding  # surf v2 web/search replaces the multi-backend grounding module
...
def _has_backend(config: dict) -> bool:
    ...
    last30days-surf: surf is the single backend, gated by SURF_API_KEY.
    """
