"""Minimal terminal UI shim for last30days-glim.
...
class ProgressDisplay:
    def __init__(self, topic: str, show_banner: bool = False) -> None:
        ...
        self._started = False
        if show_banner:
            print(f"[last30days-glim] researching: {topic}", file=sys.stderr)

    def start_processing(self) -> None:
        if self._started:
            return
        self._started = True
        print("[last30days-glim] starting research...", file=sys.stderr)
